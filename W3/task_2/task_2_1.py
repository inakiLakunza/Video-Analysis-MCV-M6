...
if __name__ == "__main__":
    ...
    N_FRAMES = 309
    FRAME_SET_PATH = "/ghome/group07/test/W3/task_2/frame_dataset/S04/c021"
    ...
    make_video(img_folder=out_img_path, start=170, end=210, name="video_task_2_4_21_det_th_07_005", out_folder="/ghome/group07/test/W3/task_2/outs_imgs_1")
    print("video1 done")
