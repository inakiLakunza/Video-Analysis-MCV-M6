...
def calculate_operations(model, clip_length, crop_height, crop_width, n_channels=3, clip_length_lower=0) -> int:
    """
    ...
    mock_input = torch.randn(1, n_channels, clip_length-clip_length_lower, crop_height, crop_width)
