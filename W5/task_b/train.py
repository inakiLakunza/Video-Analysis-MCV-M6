...
def train(
    ...
    for batch in pbar:
        ...
        if epoch:
            wandb.log({"epoch": epoch+1, "step": cont+1, "val_loss": loss_iter, "val_acc": (float(hits_iter) / len(labels))})
...
def evaluate(
    ...
    early_stopper.early_stop(loss_valid_mean(loss_iter))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--frames_dir', type=str, default="/ghome/group07/test/W5/frames/frames/",
