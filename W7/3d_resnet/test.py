...
if __name__ == "__main__":
    ...
    # LOAD MODEL
    weights_to_try = [
        # '/ghome/group07/test/W6/task_1/3d_resnet/weights/3d_resnet_50_loss.pth',
        # '/ghome/group07/test/W6/task_1/3d_resnet/weights/best_val_model_epoch_7.pth',
        # '/ghome/group07/test/W6/task_1/3d_resnet/weights/3d_resnet_freeze.pth',
        # '/ghome/group07/test/W6/task_1/3d_resnet/weights/best_val_model_epoch_38_freeze.pth',
        # '/ghome/group07/test/W6/task_1/3d_resnet/weights/3d_resnet_notpretrained.pth',
        # '/ghome/group07/test/W6/task_1/3d_resnet/weights/best_val_model_epoch_38_notpretrained.pth',
        '/ghome/group07/test/W6/task_1/3d_resnet/weights/3d_resnet_freeze_2layers.pth',
        '/ghome/group07/test/W6/task_1/3d_resnet/weights/best_val_model_freeze_2layers.pth',
    ]
